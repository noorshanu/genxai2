    ...
    <div className="bg-black  text-white  overflow-hidden  py-6">
      <div className=" flex justify-between px-4 items-center">
        <div className="flex gap-4 items-center">
          <div className=" w-full agentbox p-2  mx-2 ">
            <div className="bg-[#35425A] rounded-lg p-2 flex w-full gap-4 relative">
            ...
            <div className=" bg-[#35425A] p-2 rounded-lg  mt-2 w-full">
